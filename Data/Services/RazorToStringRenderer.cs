...
public class RazorViewToStringRenderer
{
    ...
    public async Task<string> RenderViewToStringAsync(string viewName, Transaction model)
    {
        ...
        using (var stringWriter = new StringWriter())
        {
            var viewContext = new ViewContext(
                actionContext,
                view,
                new ViewDataDictionary<Transaction>(new EmptyModelMetadataProvider(), new ModelStateDictionary())
                {
                    Model = model
                },
